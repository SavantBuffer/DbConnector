...
namespace DbConnector.Core
{
    public abstract class DbJobBase<T> : IDbJob<T>
    {
        ...
        /// <para>Note: Deferred execution is only possible for <see cref="System.Collections.IEnumerable"/> types and useful when dealing with large amounts of data. Consequently, normal execution will be used when encountering non <see cref="System.Collections.IEnumerable"/> types.</para> 
