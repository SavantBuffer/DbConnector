...
{
    public class BatchReadSingleTests : TestBase
    {
        [Fact]
        public void BatchReadSingle_2()
        {
            var result = _dbConnector.ReadSingle<Currency, Person>((cmd) =>
             {
        ...
        {
            var result = _dbConnector.ReadSingle<Currency, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
        ...
        {
            var result = _dbConnector.ReadSingle<Currency, Person, Person, Person>((cmd) =>
           {
               cmd.CommandText = @"
                    SELECT TOP(1) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadSingle<Currency, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(1) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadSingle<Currency, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(1) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadSingle<Currency, Person, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(1) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadSingle<Currency, Person, Person, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(1) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        public void BatchReadSingle_8_Exception()
        {
            ...
            {
                _dbConnector.ReadSingle<Currency, Person, Person, Person, Person, Person, Person, Person>((cmd) =>
                {
                    cmd.CommandText = @"
                        SELECT TOP(1) * FROM [Sales].[Currency];
                        SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadSingleOrDefault<Currency, Person>((cmd) =>
            {
                cmd.CommandText = "SELECT TOP(1) * FROM [Sales].[Currency]; SELECT TOP(1) * FROM [Person].[Person];";
        ...
        {
            var result = _dbConnector.ReadSingleOrDefault<Currency, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(1) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadSingleOrDefault<Currency, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(1) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadSingleOrDefault<Currency, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(1) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadSingleOrDefault<Currency, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(1) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadSingleOrDefault<Currency, Person, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(1) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadSingleOrDefault<Currency, Person, Person, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(1) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
