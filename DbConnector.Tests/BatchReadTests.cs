...
{
    public class BatchReadTests : TestBase
    {
        [Fact]
        public void BatchRead_2()
        {
            var result = _dbConnector.Read<Currency, Person>((cmd) =>
             {
        ...
        {
            var result = _dbConnector.Read<Currency, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
        ...
        {
            var result = _dbConnector.Read<Currency, Person, Person, Currency>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(10) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.Read<Currency, Person, Person, Currency, Culture>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(10) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.Read<Currency, Person, Person, Currency, Culture, Address>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(10) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.Read<Currency, Person, Person, Currency, Culture, Address, Address>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(10) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.Read<Currency, Person, Person, Currency, Culture, Address, Address, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(10) * FROM [Person].[Person];
