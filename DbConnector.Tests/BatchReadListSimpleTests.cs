...
{
    public class BatchReadListSimpleTests : TestBase
    {
        [Fact]
        public void BatchReadList_2()
        {
            var result = _dbConnector.ReadToList<Currency, Person>("SELECT TOP(3) * FROM [Sales].[Currency]; SELECT TOP(10) * FROM [Person].[Person];").Execute();
