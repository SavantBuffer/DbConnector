...
{
    public class BatchReadFirstTests : TestBase
    {
        [Fact]
        public void BatchReadFirst_2()
        {
            var result = _dbConnector.ReadFirst<Currency, Person>((cmd) =>
             {
        ...
        {
            var result = _dbConnector.ReadFirst<Currency, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
        ...
        {
            var result = _dbConnector.ReadFirst<Currency, Person, Person, Person>((cmd) =>
           {
               cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
        ...
        {
            var result = _dbConnector.ReadFirst<Currency, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadFirst<Currency, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadFirst<Currency, Person, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadFirst<Currency, Person, Person, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        public void BatchReadFirst_8_Exception()
        {
            ...
            {
                _dbConnector.ReadFirst<Currency, Person, Person, Person, Person, Person, Person, Person>((cmd) =>
                {
                    cmd.CommandText = @"
                        SELECT TOP(3) * FROM [Sales].[Currency];
                        SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadFirstOrDefault<Currency, Person>((cmd) =>
            {
                cmd.CommandText = "SELECT TOP(3) * FROM [Sales].[Currency]; SELECT TOP(10) * FROM [Person].[Person];";
        ...
        {
            var result = _dbConnector.ReadFirstOrDefault<Currency, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(10) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadFirstOrDefault<Currency, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadFirstOrDefault<Currency, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadFirstOrDefault<Currency, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadFirstOrDefault<Currency, Person, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
        ...
        {
            var result = _dbConnector.ReadFirstOrDefault<Currency, Person, Person, Person, Person, Person, Person, Person>((cmd) =>
            {
                cmd.CommandText = @"
                    SELECT TOP(3) * FROM [Sales].[Currency]; 
                    SELECT TOP(1) * FROM [Person].[Person];
